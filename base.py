questoes = [{'titulo': 'Qual o resultado da operação 57 + 32?',
         ...
         {'titulo': 'O que é Necrose?',
          ...
          'correta': 'D'},
         {'titulo': 'Quem foi o Bola de Ouro em 2013?',
                  'nivel': 'facil',
                  'opcoes': {'A': 'Cristiano Ronaldo', 'B': 'Lionel Messi', 'C': 'Neymar', 'D': 'Arjen Robben'},
                  'correta': 'A'},
         {'titulo': 'Quem é o GOAT do jiu-jitsu?',
                   'nivel': 'medio',
                   'opcoes': {'A': 'Gordon Ryan', 'B': 'Roger Gracie', 'C': 'Charles Oliveira', 'D': 'Helio Gracie'},
                   'correta': 'B'},
         {'titulo': 'Qual é a letra que vem no começo das classificações de dificuldade na escalada?',
                            'nivel': 'medio',
                            'opcoes': {'A': 'A', 'B': 'Z', 'C': 'V', 'D': 'T'},
                            'correta': 'C'},]
